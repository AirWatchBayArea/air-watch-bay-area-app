...
function fileAddedCallback(e, data){
	e.preventDefault();
...
function makePublicID(){
	...
	console.log(userHash + random + epoch);
...
function uploadingInit(){
	uploader = $('#file-upload').unsigned_cloudinary_upload("u87zingl", 
	  ...
	  progress.showProgress();
		...
		progress.error(data);
	}).bind('fileuploadadd', fileAddedCallback);
